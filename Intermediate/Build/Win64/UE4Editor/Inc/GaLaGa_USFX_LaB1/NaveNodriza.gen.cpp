...
#include "GaLaGa_USFX_LaB1/NaveNodriza.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	GALAGA_USFX_LAB1_API UClass* Z_Construct_UClass_ANaveNodriza_NoRegister();
	GALAGA_USFX_LAB1_API UClass* Z_Construct_UClass_ANaveNodriza();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_GaLaGa_USFX_LaB1();
	GALAGA_USFX_LAB1_API UClass* Z_Construct_UClass_UNaveNodrizaInterfaz_NoRegister();
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANaveNodriza_Statics::Class_MetaDataParams[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ANaveNodriza_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UNaveNodrizaInterfaz_NoRegister, (int32)VTABLE_OFFSET(ANaveNodriza, INaveNodrizaInterfaz), false },
		};
	...
	IMPLEMENT_CLASS(ANaveNodriza, 1525131763);
	template<> GALAGA_USFX_LAB1_API UClass* StaticClass<ANaveNodriza>()
	{
		return ANaveNodriza::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ANaveNodriza(Z_Construct_UClass_ANaveNodriza, &ANaveNodriza::StaticClass, TEXT("/Script/GaLaGa_USFX_LaB1"), TEXT("ANaveNodriza"), false, nullptr, nullptr, nullptr);
