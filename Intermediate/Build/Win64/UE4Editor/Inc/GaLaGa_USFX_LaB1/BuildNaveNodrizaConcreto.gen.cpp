...
#include "GaLaGa_USFX_LaB1/BuildNaveNodrizaConcreto.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	GALAGA_USFX_LAB1_API UClass* Z_Construct_UClass_ABuildNaveNodrizaConcreto_NoRegister();
	GALAGA_USFX_LAB1_API UClass* Z_Construct_UClass_ABuildNaveNodrizaConcreto();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABuildNaveNodrizaConcreto_Statics::Class_MetaDataParams[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ABuildNaveNodrizaConcreto_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UBuildNave_NoRegister, (int32)VTABLE_OFFSET(ABuildNaveNodrizaConcreto, IBuildNave), false },
		};
	...
	IMPLEMENT_CLASS(ABuildNaveNodrizaConcreto, 2107100715);
	template<> GALAGA_USFX_LAB1_API UClass* StaticClass<ABuildNaveNodrizaConcreto>()
	{
		return ABuildNaveNodrizaConcreto::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABuildNaveNodrizaConcreto(Z_Construct_UClass_ABuildNaveNodrizaConcreto, &ABuildNaveNodrizaConcreto::StaticClass, TEXT("/Script/GaLaGa_USFX_LaB1"), TEXT("ABuildNaveNodrizaConcreto"), false, nullptr, nullptr, nullptr);
