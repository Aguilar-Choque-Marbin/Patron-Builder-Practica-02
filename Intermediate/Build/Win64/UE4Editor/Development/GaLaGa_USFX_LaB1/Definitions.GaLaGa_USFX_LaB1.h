...
#define UE_PROJECT_NAME GaLaGa_USFX_LaB1
#define UE_TARGET_NAME GaLaGa_USFX_LaB1Editor
#define UE_MODULE_NAME "GaLaGa_USFX_LaB1"
...
#define GALAGA_USFX_LAB1_API DLLEXPORT
